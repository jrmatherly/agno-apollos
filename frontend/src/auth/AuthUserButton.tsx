  ...
  if (!isAuthenticated) {
    return (
      <div className="flex flex-col items-start gap-2">
        <div className="text-xs font-medium uppercase text-primary">Auth</div>
        <Button
          variant="ghost"
          onClick={login}
          className="h-9 w-full rounded-xl border border-primary/15 bg-accent text-xs font-medium uppercase text-muted hover:bg-accent/80"
        >
