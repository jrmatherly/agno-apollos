...
| `MCP_GATEWAY_ADMIN_GROUPS` | (empty) | Comma-separated Entra group IDs for gateway admin access |
| `MCP_GATEWAY_ROLE_MAPPINGS` | (empty) | JSON mapping of Entra groups to gateway roles |
