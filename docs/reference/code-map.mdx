...
└── settings/
    ...
    ├── mcp/                 # MCP Gateway admin
    │   ├── page.tsx         # 6 RBAC-filtered tabs
    │   └── components/      # ServersTab, ToolsTab, VirtualServersTab, ResourcesTab, PromptsTab, ConfigTab
    └── integrations/page.tsx  # Redirect to /settings/mcp
