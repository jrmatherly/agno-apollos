...
| `backend/tools/` | Custom tools (search, awareness, approval-gated ops, introspect, save_query) |
| `backend/context/` | Agent context providers (semantic model, business rules, intent routing) |
...
| `backend/evals/` | Evaluation harness (LLM grading, golden SQL comparison, Rich CLI) |
