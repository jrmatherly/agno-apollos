...
Loads metrics, business rules, and common gotchas from JSON files.
Injected into data agent instructions alongside the semantic model.
"""
...
BUSINESS_DIR = Path(__file__).parent.parent.parent / "data" / "business"
