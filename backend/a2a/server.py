        ...
        "skills": [
            {
                ...
                "tags": ["knowledge-base", "document-search", "question-answering"],
            },
        ],
    },
    "data-agent": {
        ...
        "skills": [
            {
                "id": "data-query",
                "name": "Data Query",
                "description": "Query databases and analyze data with SQL",
        ...
        "skills": [
            {
                ...
                "tags": ["web-search", "news", "real-time"],
            },
        ],
    },
    "reasoning-agent": {
        ...
        "skills": [
            {
                ...
                "tags": ["reasoning", "analysis", "research", "reports"],
            },
        ],
    },
    "mcp-agent": {
